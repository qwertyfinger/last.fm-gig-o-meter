...
public class ArtistContract {
    ...
    public static final String CREATE =
            "CREATE TABLE " + TABLE_NAME + "(" + COLUMN_NAME + " VARCHAR(255) PRIMARY KEY," + COLUMN_MBID +
                    " VARCHAR(255) NOT NULL DEFAULT ''," + COLUMN_PLAYCOUNT + " BIGINT NOT NULL DEFAULT 0," +
                    COLUMN_IMAGE_URL + " TEXT," + COLUMN_COMPATIBILITY + " DOUBLE NOT NULL DEFAULT 0," +
                    COLUMN_AVERAGE_SONGS_NMB + " INTEGER NOT NULL DEFAULT 0," + COLUMN_CONCERTS_NMB +
                    " INTEGER NOT NULL DEFAULT 0," + COLUMN_SYNC_STATUS + " INTEGER NOT NULL DEFAULT 0);";
    ...
    public static ArtistDb parseCursor(Cursor cursor) {
        ...
        artist.setAverageNmbOfSongs(cursor.getDouble(cursor.getColumnIndexOrThrow(COLUMN_AVERAGE_SONGS_NMB)));
