...
public interface LastFmService {
    ...
    Observable<TrackList> getTopTracks(@Query(value = "api_key") String apiKey, @Query(value = "user") String user,
                                       @Query(value = "limit") int limit, @Query(value = "page") int page);

    @GET("?method=user.getlovedtracks")
    Observable<TrackList> getLovedTracks(@Query(value = "api_key") String apiKey, @Query(value = "user") String user,
                                  @Query(value = "limit") int limit, @Query(value = "page") int page);

    @GET("?method=user.getinfo")
    Observable<ResponseLastFm> checkUser(@Query(value = "api_key") String apiKey, @Query(value = "user") String user);
