...
public class ArtistListFragment extends android.support.v4.app.Fragment implements ArtistsListMvpView,
        LoginDialogListener, EraseDialogListener, AddArtistDialogListener {
...
//                return true;
    ...
    @Override
    public void onFinishAddArtistsDialog(int number) {
    ...
    @Override
    public void displayRankings(List<ArtistDb> artists) {
