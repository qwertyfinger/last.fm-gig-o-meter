...
package com.qwertyfinger.lastfm_gig_o_meter.util.leak;
...
public class IMMLeaks {
  ...
  static class ReferenceCleaner
    ...
    @TargetApi(Build.VERSION_CODES.KITKAT) private void clearInputMethodManagerLeak() {
      try {
   ...
   */
  @TargetApi(Build.VERSION_CODES.KITKAT) public static void fixFocusedViewLeak(
